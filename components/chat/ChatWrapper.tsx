...
const  ChatWrapper = ({ fileId }: ChatWrapperProps) => { // isLoading means when we don't have data from api call
    ...
    if(isLoading) return (<div className="relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 flex-col justify-between gap-2">
